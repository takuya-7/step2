            ...
            <form method="POST" action="{{ route('steps.update', $step->id) }}" class="c-form">
                ...
                <div class="c-form__field">
                  ...
                  <div class="c-form__child-item">
                    ...
                    <div class="c-form__child-item__right">
                      <input id="estimated_achievement_day" type="text" name="estimated_achievement_day" placeholder="例：3" value="{{ old('estimated_achievement_day', isset($step->estimated_achievement_day) ? $step->estimated_achievement_day : '') }}" class="">
                  ...
                  <div class="c-form__child-item">
                    ...
                    <div class="c-form__child-item__right">
                      <input id="estimated_achievement_hour" type="text" name="estimated_achievement_hour" placeholder="例：6" value="{{ old('estimated_achievement_hour', isset($step->estimated_achievement_hour) ? $step->estimated_achievement_hour : '') }}" class="">
                ...
                @for ($i = 1; $i <= $child_steps_num; $i++)
                  <fieldset class="c-form__field">
                    ...
                    <input id="child-step{{ $i }}-title" type="text" name="child-step{{ $i }}-title" value="{{ old('child-step'.$i.'-title', isset($child_steps[$i-1]['title']) ? $child_steps[$i-1]['title'] : '') }}" class="" placeholder="学ぶ手順の見出し">
                  </fieldset>

                  <fieldset class="c-form__field">
                    <textarea name="child-step{{ $i }}-description" id="child-step{{ $i }}-description" class="c-form__field__textarea" style="min-height: 8rem;" placeholder="具体的にやること、コツやポイントについて">{{ old('child-step'.$i.'-description', isset($child_steps[$i-1]['description']) ? $child_steps[$i-1]['description'] : '') }}</textarea>
                  </fieldset>
                @endfor
