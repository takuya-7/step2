...
return [
    ...
    */
    ...
    'attributes' => [
        'title' => 'タイトル',
        'estimated_achievement_day' => '所要日数',
        'estimated_achievement_hour' => '所要時間',
        'description' => '概要',
        'category_id' => 'カテゴリー',
        'child-step1-title' => 'ステップ1見出し',
        'child-step2-title' => 'ステップ2見出し',
        'child-step3-title' => 'ステップ3見出し',
        'child-step4-title' => 'ステップ4見出し',
        'child-step5-title' => 'ステップ5見出し',
        'child-step6-title' => 'ステップ6見出し',
        'child-step7-title' => 'ステップ7見出し',
        'child-step8-title' => 'ステップ8見出し',
        'child-step9-title' => 'ステップ9見出し',
        'child-step10-title' => 'ステップ10見出し',
        'child-step1-description' => 'ステップ1説明',
        'child-step2-description' => 'ステップ2説明',
        'child-step3-description' => 'ステップ3説明',
        'child-step4-description' => 'ステップ4説明',
        'child-step5-description' => 'ステップ5説明',
        'child-step6-description' => 'ステップ6説明',
        'child-step7-description' => 'ステップ7説明',
        'child-step8-description' => 'ステップ8説明',
        'child-step9-description' => 'ステップ9説明',
        'child-step10-description' => 'ステップ10説明',
    ],
